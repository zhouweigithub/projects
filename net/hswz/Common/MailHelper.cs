...
namespace Hswz.Common
{
    ...
    public class MailHelper
    {
        ...
        /// </summary>
        private static readonly String FromEmailAddress = "Monitor10@app366.com";

        /// <summary>
        /// 主邮箱密码Moqikaka366
        /// </summary>
        private static readonly String FromEmailPassword = "Monitor_moqikaka366";

        /// <summary>
        /// 主机
        /// </summary>
        private static readonly String EmailHost = "smtp.exmail.qq.com";

        /// <summary>
        /// 重发次数
        /// </summary>
        private static readonly Int32 ReSendTimes = 3;

        /// <summary>
        /// 重发间隔时间
        /// </summary>
        private static readonly Int32 SleepMinute = 120;
