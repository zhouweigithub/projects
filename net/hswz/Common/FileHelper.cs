...
namespace Hswz.Common
{
    public class FileHelper
    {
        ...
        public static Boolean Contains(String directoryPath, String searchPattern)
        {
            try
            {
                //获取指定的文件列表
        ...
        public static Boolean Contains(String directoryPath, String searchPattern, Boolean isSearchChild)
        {
            try
            {
                //获取指定的文件列表
        ...
        /// </summary>
        /// <param name="filePath">文件的绝对路径</param>        
        public static Int32 GetFileSize(String filePath)
        {
            //创建一个文件对象
            FileInfo fi = new FileInfo(filePath);
            //获取文件的大小
            return (Int32)fi.Length;
        }
        /// <summary>
        /// 获取一个文件的长度,单位为KB
        /// </summary>
        ...
        public static Double GetFileSizeByMB(String filePath)
        {
            ...
            FileInfo fi = new FileInfo(filePath);
            //获取文件的大小
            return (Double)fi.Length / 1024 / 1024;
        }
        #endregion
        #region 获取指定目录中的文件列表
        /// <summary>
        ...
        {
            //向文件写入内容 www.2cto.com 
            File.WriteAllText(filePath, content);
        }
        #endregion
        #region 向文本文件的尾部追加内容
        /// <summary>
        /// 向文本文件的尾部追加内容（如果文件不存在，则创建一个文件）
        /// </summary>
        /// <param name="filePath">文件的绝对路径</param>
        /// <param name="content">写入的内容</param>
        ...
        {
            //获取文件的大小 
            Int32 fileSize = GetFileSize(filePath);
            //创建一个临时缓冲区
